...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            dest="generate_zaak_inzage_data",
            action="store_true",
            default=False,
            help=(
                "Create three zaak-inzage benchmark cases containing 1, 3 and "
                "5 records in every collection"
            ),
        )
    ...
    def handle(self, *args, **options):
        ...
        generate_zaak_inzage_data = options["generate_zaak_inzage_data"]
