...
class DSOApiStrategyTests(APITestCase):
    ...
    def test_api_19_documentation_version_json(self):
        url = reverse('schema-json-brc', kwargs={'format': '.json'})
    ...
    def test_api_19_documentation_version_yaml(self):
        url = reverse('schema-json-brc', kwargs={'format': '.yaml'})
    ...
    @override_settings(ROOT_URLCONF='openzaak.brc.api.tests.test_urls')
