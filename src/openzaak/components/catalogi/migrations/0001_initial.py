    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_admin_name', models.CharField(help_text='Naam voor interne doeleinden. Dit attribuut wordt niet ontsloten via de API.', max_length=100, verbose_name='naam')),
                ...
                ('rsin', vng_api_common.fields.RSINField(db_index=True, help_text='Het door een kamer toegekend uniek nummer voor de INGESCHREVEN NIET-NATUURLIJK PERSOON die de eigenaar is van een CATALOGUS.', max_length=9, verbose_name='rsin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept', models.BooleanField(db_index=True, default=True, help_text='Geeft aan of het object een concept betreft. Concepten zijn niet-definitieve versies en zouden niet gebruikt moeten worden buiten deze API.', verbose_name='concept')),
                ('uuid', models.UUIDField(default=uuid.uuid4, help_text='Unieke resource identifier (UUID4)', unique=True)),
                ...
                ('catalogus', models.ForeignKey(help_text='URL-referentie naar de CATALOGUS waartoe dit INFORMATIEOBJECTTYPE behoort.', on_delete=django.db.models.deletion.CASCADE, to='catalogi.Catalogus')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept', models.BooleanField(db_index=True, default=True, help_text='Geeft aan of het object een concept betreft. Concepten zijn niet-definitieve versies en zouden niet gebruikt moeten worden buiten deze API.', verbose_name='concept')),
                ('uuid', models.UUIDField(default=uuid.uuid4, help_text='Unieke resource identifier (UUID4)', unique=True)),
                ('identificatie', models.CharField(blank=True, db_index=True, help_text='Unieke identificatie van het ZAAKTYPE binnen de CATALOGUS waarin het ZAAKTYPE voorkomt.', max_length=50, validators=[vng_api_common.validators.AlphanumericExcludingDiacritic()], verbose_name='identificatie')),
                ...
                ('doorlooptijd_behandeling', openzaak.utils.fields.DurationField(help_text='De periode waarbinnen volgens wet- en regelgeving een ZAAK van het ZAAKTYPE afgerond dient te zijn, in kalenderdagen.', verbose_name='doorlooptijd behandeling')),
                ('servicenorm_behandeling', openzaak.utils.fields.DurationField(blank=True, help_text='De periode waarbinnen verwacht wordt dat een ZAAK van het ZAAKTYPE afgerond wordt conform de geldende servicenormen van de zaakbehandelende organisatie(s).', null=True, verbose_name='servicenorm behandeling')),
                ...
                ('verlengingstermijn', openzaak.utils.fields.DurationField(blank=True, help_text='De termijn (typisch een aantal dagen) waarmee de Doorlooptijd behandeling van ZAAKen van dit ZAAKTYPE kan worden verlengd. Mag alleen een waarde bevatten als verlenging mogelijk is.', null=True, verbose_name='verlengingstermijn')),
                ('trefwoorden', django_better_admin_arrayfield.models.fields.ArrayField(base_field=models.CharField(max_length=30, verbose_name='trefwoord'), blank=True, db_index=True, default=list, help_text='Een trefwoord waarmee ZAAKen van het ZAAKTYPE kunnen worden gekarakteriseerd.', size=None)),
                ...
                ('catalogus', models.ForeignKey(help_text='URL-referentie naar de CATALOGUS waartoe dit ZAAKTYPE behoort.', on_delete=django.db.models.deletion.CASCADE, to='catalogi.Catalogus')),
                ('deelzaaktypen', models.ManyToManyField(blank=True, help_text='De ZAAKTYPE(n) waaronder ZAAKen als deelzaak kunnen voorkomen bij ZAAKen van dit ZAAKTYPE.', related_name='hoofdzaaktypen', to='catalogi.ZaakType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('richting', models.CharField(choices=[('inkomend', 'Inkomend'), ('intern', 'Intern'), ('uitgaand', 'Uitgaand')], db_index=True, help_text='Aanduiding van de richting van informatieobjecten van het gerelateerde INFORMATIEOBJECTTYPE bij zaken van het gerelateerde ZAAKTYPE.', max_length=20, verbose_name='richting')),
                ...
                ('zaaktype', models.ForeignKey(help_text='URL-referentie naar het ZAAKTYPE.', on_delete=django.db.models.deletion.CASCADE, to='catalogi.ZaakType', verbose_name='zaaktype')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='zaaktype',
            field=models.ForeignKey(help_text='URL-referentie naar het ZAAKTYPE van ZAAKen waarin STATUSsen van dit STATUSTYPE bereikt kunnen worden.', on_delete=django.db.models.deletion.CASCADE, related_name='statustypen', to='catalogi.ZaakType'),
        ),
        migrations.AddField(
            model_name='informatieobjecttype',
            name='zaaktypen',
            field=models.ManyToManyField(help_text='ZAAKTYPE met ZAAKen die relevant kunnen zijn voor dit INFORMATIEOBJECTTYPE', related_name='informatieobjecttypen', through='catalogi.ZaakTypeInformatieObjectType', to='catalogi.ZaakType'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('omschrijving', models.CharField(help_text='Omschrijving van de aard van de ROL.', max_length=100, verbose_name='omschrijving')),
                ('omschrijving_generiek', models.CharField(choices=[('adviseur', 'Adviseur'), ('behandelaar', 'Behandelaar'), ('belanghebbende', 'Belanghebbende'), ('beslisser', 'Beslisser'), ('initiator', 'Initiator'), ('klantcontacter', 'Klantcontacter'), ('zaakcoordinator', 'Zaakcoördinator'), ('mede_initiator', 'Mede-initiator')], db_index=True, help_text='Algemeen gehanteerde omschrijving van de aard van de ROL.', max_length=20, verbose_name='omschrijving generiek')),
                ('zaaktype', models.ForeignKey(help_text='URL-referentie naar het ZAAKTYPE waar deze ROLTYPEn betrokken kunnen zijn.', on_delete=django.db.models.deletion.CASCADE, to='catalogi.ZaakType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zaaktype', models.ForeignKey(help_text='URL-referentie naar het ZAAKTYPE van ZAAKen waarin resultaten van dit RESULTAATTYPE bereikt kunnen worden.', on_delete=django.db.models.deletion.CASCADE, related_name='resultaattypen', to='catalogi.ZaakType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specificatie_van_eigenschap', models.ForeignKey(blank=True, help_text='Attribuutkenmerken van de eigenschap', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalogi.EigenschapSpecificatie', verbose_name='specificatie van eigenschap')),
                ('zaaktype', models.ForeignKey(help_text='URL-referentie naar het ZAAKTYPE van de ZAAKen waarvoor deze EIGENSCHAP van belang is.', on_delete=django.db.models.deletion.CASCADE, to='catalogi.ZaakType')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reactietermijn', openzaak.utils.fields.DurationField(blank=True, help_text='De duur (typisch een aantal dagen), gerekend vanaf de verzend- of publicatiedatum, waarbinnen verweer tegen een besluit van het besluittype mogelijk is.', null=True, verbose_name='reactietermijn')),
                ...
                ('publicatietermijn', openzaak.utils.fields.DurationField(blank=True, help_text='De duur (typisch een aantal dagen), gerekend vanaf de verzend- of publicatiedatum, dat BESLUITen van dit BESLUITTYPE gepubliceerd moeten blijven.', null=True, verbose_name='publicatietermijn')),
                ('toelichting', models.TextField(blank=True, help_text='Een eventuele toelichting op dit BESLUITTYPE.', verbose_name='toelichting')),
                ('catalogus', models.ForeignKey(help_text='URL-referentie naar de CATALOGUS waartoe dit BESLUITTYPE behoort.', on_delete=django.db.models.deletion.CASCADE, to='catalogi.Catalogus')),
                ('informatieobjecttypen', models.ManyToManyField(blank=True, help_text='URL-referenties naar het INFORMATIEOBJECTTYPE van informatieobjecten waarin besluiten van dit BESLUITTYPE worden vastgelegd.', related_name='besluittypen', to='catalogi.InformatieObjectType')),
                ('zaaktypen', models.ManyToManyField(help_text='ZAAKTYPE met ZAAKen die relevant kunnen zijn voor dit BESLUITTYPE', related_name='besluittypen', to='catalogi.ZaakType')),
            ],
            options={
