...
class RolTypeFilterAPITests(APITestCase):
    ...
    def test_filter_roltype_omschrijving(self):
        ...
        omschrijving_1_url = reverse("roltype-detail", kwargs={"uuid": rt1.uuid})
        omschrijving_3_url = reverse("roltype-detail", kwargs={"uuid": rt3.uuid})
        ...
        omschrijving_2_url = reverse("roltype-detail", kwargs={"uuid": rt2.uuid})
        self.assertNotIn(
