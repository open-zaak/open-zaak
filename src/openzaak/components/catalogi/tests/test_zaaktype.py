...
class ZaakTypeAPITests(TypeCheckMixin, APITestCase):
    ...
    def test_get_zaaktype_includes_bron_fields(self):
        ...
        zaaktype = ZaakTypeFactory.create(
            ...
            broncatalogus_url=f"http://testserver{catalog1.get_absolute_api_url()}",
            bronzaaktype_identificatie=bron_zaaktype.identificatie,
            bronzaaktype_omschrijving=bron_zaaktype.zaaktype_omschrijving,
            bronzaaktype_url=f"http://testserver{get_operation_url('zaaktype_read', uuid=bron_zaaktype.uuid)}",
        )
        ...
        expected_broncatalogus = {
            "url": f"http://testserver{catalog1.get_absolute_api_url()}",
        ...
        expected_bronzaaktype = {
            "url": f"http://testserver{get_operation_url('zaaktype_read', uuid=bron_zaaktype.uuid)}",
