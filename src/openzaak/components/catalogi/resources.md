...
Objecttype op [GEMMA Online](https://www.gemmaonline.nl/index.php/Rgbz_1.0/doc/objecttype/checklistitem)
...
| checklistitemStatustype | Te controleren aandachtspunt voorafgaand aan het bereiken van een status van het STATUSTYPE. | array | nee | C​R​U​D |
| catalogus | URL-referentie naar de CATALOGUS waartoe dit ZAAKTYPE behoort. | string | nee | ~~C~~​R​~~U~~​~~D~~ |
