...
class ZaakObjectType(GeldigheidMixin, models.Model):
    ...
    statustype = models.ForeignKey(
        'catalogi.StatusType', verbose_name=_('status type'), blank=True, null=True,
    ...
    is_relevant_voor = models.ForeignKey(
        'catalogi.ZaakType', verbose_name=_('is_relevant_voor'), help_text=_(
...
class ZaakType(APIMixin, ConceptMixin, GeldigheidMixin, models.Model):
    ...
    formulier = models.ManyToManyField(
        'catalogi.Formulier', verbose_name=_('formulier'), blank=True,
    ...
    broncatalogus = models.ForeignKey(
        'catalogi.BronCatalogus', verbose_name=_('broncatalogus'),
        blank=True, null=True, on_delete=models.CASCADE,
        help_text=_('De CATALOGUS waaraan het ZAAKTYPE is ontleend.')
    )
    bronzaaktype = models.ForeignKey(
        'catalogi.BronZaakType', verbose_name=('bronzaaktype'),
        blank=True, null=True, on_delete=models.CASCADE,
    ...
    is_deelzaaktype_van = models.ManyToManyField(
        'catalogi.ZaakType', verbose_name=_('is deelzaaktype van'), blank=True,
    ...
    catalogus = models.ForeignKey(
        'catalogi.Catalogus', verbose_name=_('maakt deel uit van'), on_delete=models.CASCADE,
