...
class InformatieObjectType(GeldigheidMixin, ConceptMixin, models.Model):
    ...
    omschrijving_generiek = models.ForeignKey(
        'catalogi.InformatieObjectTypeOmschrijvingGeneriek', verbose_name=_('omschrijving generiek'),
    ...
    catalogus = models.ForeignKey(
        'catalogi.Catalogus', verbose_name=_('maakt deel uit van'),
    ...
    zaaktypes = models.ManyToManyField(
        'catalogi.ZaakType', verbose_name=_('zaaktypes'),
