...
class Eigenschap(models.Model):
    ...
    **Toelichting objecttype**
    ...
    specificatie_van_eigenschap = models.ForeignKey(
        'catalogi.EigenschapSpecificatie', verbose_name=_('specificatie van eigenschap'),
        blank=True, null=True, help_text=_('Attribuutkenmerken van de eigenschap'),
        on_delete=models.CASCADE
    )
    referentie_naar_eigenschap = models.ForeignKey(
        'catalogi.EigenschapReferentie', verbose_name=_('referentie naar eigenschap'),
    ...
    statustype = models.ForeignKey(
        'catalogi.StatusType', verbose_name=_('status type'),
        blank=True, null=True, on_delete=models.CASCADE,
    ...
    zaaktype = models.ForeignKey('catalogi.ZaakType', verbose_name=_('is van'), help_text=_(
