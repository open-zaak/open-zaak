...
class ResultaatType(models.Model):
    ...
    zaaktype = models.ForeignKey(
        'catalogi.ZaakType', verbose_name=_("is relevant voor"),
    ...
    bepaalt_afwijkend_archiefregime_van = models.ManyToManyField(
        'catalogi.ZaakInformatieObjectType', verbose_name=_('bepaalt afwijkend archiefregime van'),
        through='catalogi.ZaakInformatieobjectTypeArchiefregime', blank=True, related_name='resultaattypes',
        help_text=_(
    ...
    heeft_verplichte_zot = models.ManyToManyField(
        'catalogi.ZaakObjectType', verbose_name=_('heeft verplichte'), blank=True, help_text=_(
    ...
    heeft_verplichte_ziot = models.ManyToManyField(  # does not have a mnemonic, I choose 'ziot' here
        'catalogi.ZaakInformatieObjectType', verbose_name=_('heeft verplichte zaakinformatie objecttype'),
