...
class EigenschapViewSet(
    ...
    def partial_update(self, request, *args, **kwargs):
        ...
        logger.info(
            "eigenschap_partial_update_completed",
            user=str(request.user),
            uuid=kwargs.get("uuid"),
            view=self.__class__.__name__,
        )
