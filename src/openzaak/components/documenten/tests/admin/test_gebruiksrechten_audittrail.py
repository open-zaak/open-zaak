...
from ..factories import GebruiksrechtenFactory, EnkelvoudigInformatieObjectFactory
...
class GebruiksrechtenAdminTests(AdminTestMixin, TestCase):
    ...
    def test_change_gebruiksrechten(self):
        ...
        informatieobject_url = get_operation_url(
            "enkelvoudiginformatieobject_read", uuid=informatieobject.latest_version.uuid
        )
        change_url = reverse('admin:documenten_gebruiksrechten_change', args=(gebruiksrechten.pk,))
        data = {
    ...
    def test_delete_gebruiksrechten_action(self):
        ...
        data = {'action': 'delete_selected', '_selected_action': [gebruiksrechten.id], 'post': 'yes'}
    ...
    def test_delete_gebruiksrechten(self):
        ...
        delete_url = reverse('admin:documenten_gebruiksrechten_delete', args=(gebruiksrechten.pk,))
        data = {'post': 'yes'}
