...
@tag("gh-2282", "aws-s3-storage", "documenten-import-upload")
class ImportDocumentenUploadTests(
    AWSS3torageMixin, ImportTestMixin, VCRMixin, JWTAuthMixin, APITestCase
):
