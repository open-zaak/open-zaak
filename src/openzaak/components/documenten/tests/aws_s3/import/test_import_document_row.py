...
class ImportDocumentRowTests(AWSS3torageMixin, ImportTestMixin, VCRMixin, TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.field = EnkelvoudigInformatieObject.inhoud.field
        cls.field.upload_to = "uploads/test/"
    ...
    def test_minimum_fields(self):
        ...
        # assert that it's stored in AWS
...
class ImportDocumentRowWithoutOverwriteTests(
    AWSS3torageMixin, ImportTestMixin, VCRMixin, TestCase
):
    clean_documenten_files = True
    clean_import_files = True
    aws_s3_overwrite_files = False
    ...
    # Mock this to ensure the requests made to AWS match the cassettes
    ...
    def test_file_already_exists_in_storage(self, _):
        ...
        # Make sure the file already exists in AWS S3 storage
        ...
        self.assertTrue(
            actual_file_path.startswith(
                "documenten/uploads/test/already_exists_1234567"
            )
        )
