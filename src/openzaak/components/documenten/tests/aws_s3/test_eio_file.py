...
class EnkelvoudigInformatieObjectFileAwsS3StorageTests(
    JWTAuthMixin, AWSS3torageMixin, VCRMixin, APITestCase
):
    ...
    def test_create_enkelvoudiginformatieobject_aws_s3_request_exception(self):
        """
        Registreer een ENKELVOUDIGINFORMATIEOBJECT
        """
        informatieobjecttype = InformatieObjectTypeFactory.create(concept=False)
        ...
        data = {
            ...
            "taal": "dut",
            "inhoud": base64.b64encode(b"Extra tekst in bijlage").decode("utf-8"),
            "bestandsnaam": "test_create_enkelvoudiginformatieobject_aws_s3_request_exception.bin",
            "informatieobjecttype": f"http://testserver{informatieobjecttype_url}",
            "vertrouwelijkheidaanduiding": VertrouwelijkheidsAanduiding.openbaar,
        }
