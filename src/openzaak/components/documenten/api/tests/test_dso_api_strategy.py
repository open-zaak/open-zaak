...
class DSOApiStrategyTests(APITestCase):
    ...
    def test_api_19_documentation_version_json(self):
        url = reverse('schema-json-documenten', kwargs={'format': '.json'})
    ...
    def test_api_19_documentation_version_yaml(self):
        url = reverse('schema-json-documenten', kwargs={'format': '.yaml'})
    ...
    @override_settings(ROOT_URLCONF='openzaak.components.documenten.api.tests.test_urls')
