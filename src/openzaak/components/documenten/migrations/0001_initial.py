    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identificatie', models.CharField(blank=True, db_index=True, default='', help_text='Een binnen een gegeven context ondubbelzinnige referentie naar het INFORMATIEOBJECT.', max_length=40, validators=[vng_api_common.validators.AlphanumericExcludingDiacritic()])),
                ('bronorganisatie', vng_api_common.fields.RSINField(db_index=True, help_text='Het RSIN van de Niet-natuurlijk persoon zijnde de organisatie die het informatieobject heeft gecreëerd of heeft ontvangen en als eerste in een samenwerkingsketen heeft vastgelegd.', max_length=9)),
                ...
                ('_informatieobjecttype_url', models.URLField(blank=True, help_text='URL-referentie naar extern INFORMATIEOBJECTTYPE (in een andere Catalogi API).', max_length=1000, verbose_name='extern informatieobjecttype')),
                ...
                ('begin_registratie', models.DateTimeField(auto_now=True, db_index=True, help_text='Een datumtijd in ISO8601 formaat waarop deze versie van het INFORMATIEOBJECT is aangemaakt of gewijzigd.')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lock', models.CharField(blank=True, default='', help_text='Hash string, wordt gebruikt als ID voor de lock', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startdatum', models.DateTimeField(db_index=True, help_text='Begindatum van de periode waarin de gebruiksrechtvoorwaarden van toepassing zijn. Doorgaans is de datum van creatie van het informatieobject de startdatum.', verbose_name='startdatum')),
                ('einddatum', models.DateTimeField(blank=True, db_index=True, help_text='Einddatum van de periode waarin de gebruiksrechtvoorwaarden van toepassing zijn.', null=True, verbose_name='einddatum')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_zaak_url', models.URLField(blank=True, max_length=1000, verbose_name='extern zaak')),
                ('_besluit_url', models.URLField(blank=True, max_length=1000, verbose_name='extern besluit')),
                ('_besluit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='besluiten.Besluit')),
            ],
            options={
