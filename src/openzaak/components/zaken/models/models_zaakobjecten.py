...
class Adres(models.Model):
    ...
    natuurlijkpersoon = models.OneToOneField(
        'zaken.NatuurlijkPersoon', on_delete=models.CASCADE, null=True, related_name='verblijfsadres'
    )
    vestiging = models.OneToOneField(
        'zaken.Vestiging', on_delete=models.CASCADE, null=True, related_name='verblijfsadres'
    )
