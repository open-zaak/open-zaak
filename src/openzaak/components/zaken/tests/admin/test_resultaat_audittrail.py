...
from ..factories import ZaakFactory, ResultaatFactory
...
class ResultaatAdminTests(AdminTestMixin, TestCase):
    ...
    def test_create_resultaat(self):
        ...
        resultaat_url = get_operation_url("resultaat_read", uuid=resultaat.uuid, zaak_uuid=zaak.uuid)
    ...
    def test_delete_resultaat_action(self):
        ...
        data = {'action': 'delete_selected', '_selected_action': [resultaat.id], 'post': 'yes'}
