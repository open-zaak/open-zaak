...
class ExternalRelevanteZakenTestsTestCase(JWTAuthMixin, APITestCase):
    ...
    def test_create_external_relevante_andere_zaak(self):
        ...
        zaak_external = "https://externe.zaken.nl/api/v1/zaken/a620b183-d898-4576-ae94-3f21d43cc576"

        with requests_mock.Mocker(real_http=True) as m:
            m.register_uri("GET", zaak_external, json=get_zaak_response(zaak_external, zaaktype_url))
