...
class SendNotifTestCase(NotificationsConfigMixin, JWTAuthMixin, APITestCase):
                ...
                call(
                    {
                        ...
                        "hoofdObject": data["zaak"]["url"],
                        "resource": "zaakobject",
                        "resourceUrl": data["zaakobjecten"][0]["url"],
                        "actie": "create",
                        "aanmaakdatum": "2012-01-14T00:00:00Z",
                        "kenmerken": {
                            "bronorganisatie": zaak.bronorganisatie,
                ...
                call(
                    {
                        ...
                        "hoofdObject": data["zaak"]["url"],
                        "resource": "zaakobject",
                        "resourceUrl": data["zaakobjecten"][1]["url"],
                        "actie": "create",
                        "aanmaakdatum": "2012-01-14T00:00:00Z",
                        "kenmerken": {
                            "bronorganisatie": zaak.bronorganisatie,
                ...
                call(
                    {
                        ...
                        "resourceUrl": data["zaakinformatieobjecten"][0]["url"],
                        "actie": "create",
                        "aanmaakdatum": "2012-01-14T00:00:00Z",
                        "kenmerken": {
                            "bronorganisatie": zaak.bronorganisatie,
    ...
    @tag("convenience-endpoints")
    def test_send_notif_verleng_zaak(self, mock_notif):
        zaaktype = ZaakTypeFactory.create(concept=False)
        zaaktype_url = self.check_for_instance(zaaktype)
