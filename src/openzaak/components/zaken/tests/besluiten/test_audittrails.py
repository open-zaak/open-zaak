...
class AuditTrailTests(JWTAuthMixin, APITestCase):
    ...
    def test_partial_update_besluit_audittrails_add_zaak(self):
        ...
        self.assertEqual(zaken_update_audittrail.oud, besluit_data)
        self.assertEqual(zaken_update_audittrail.nieuw, response.data)
    ...
    def test_read_audittrail(self):
        ...
        audittrails_url = reverse(
            audittrails, kwargs={"besluit_uuid": besluit.uuid}, namespace="zaken"
        )
