...
from openzaak.components.documenten.tests.utils import get_eio_response, serialise_eio
from openzaak.utils.tests import JWTAuthMixin, mock_client, APICMISTestCase
...
class ZaakInformatieObjectValidationCMISTests(JWTAuthMixin, APICMISTestCase):
    ...
    def test_update_informatieobject_fails(self):
        ...
        response = self.client.patch(
            zio_url, {"informatieobject": io_url}
        )
