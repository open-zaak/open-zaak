...
class StatusSerializer(serializers.HyperlinkedModelSerializer):
    ...
    def create(self, validated_data):
        ...
        is_deelzaak = zaak.hoofdzaak and zaak.resultaat.resultaattype.brondatum_archiefprocedure_afleidingswijze == Afleidingswijze.hoofdzaak
    ...
    def _update_deelzaken_with_external_catalogi(self, qs, brondatum: date | None):
        for deelzaak in qs.iterator():
            ...
            if (
                ...
                deelzaak.save(
                    update_fields=["archiefnominatie", "archiefactiedatum", "startdatum_bewaartermijn"]
                )
