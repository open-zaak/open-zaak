...
class ZaakViewSet(
    ...
    @extend_schema(
        ...
        description=mark_experimental(
            "Reserve a zaak number without creating a case."
            "This number then cannot be generated by another reservation or zaak creation."
            "The zaak first created with the reserved number will be the owner and the number cannot be reused."
        ),
