...
class ZaakViewSet(
    ...
    required_scopes = {
        ...
        "reserve_identiteit": SCOPE_ZAKEN_CREATE,
    ...
    @extend_schema(
        "zaak_reserve_identity",
        summary="Reserve an zaak Identity.",
        description=(
            "Reserve a zaak identity without creating a case."
            "This identity then cannot be generated by another reservation or zaak creation."
            "The zaak first created with the reserved identity will be the owner and the indentity cannot be resued."
        ),
    ...
    @action(methods=("post",), detail=False, url_name="reserve_identity")
    def reserve_identiteit(self, request, *args, **kwargs):
