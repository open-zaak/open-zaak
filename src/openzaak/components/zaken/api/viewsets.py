...
queries = [
    'SELECT DISTINCT "zaken_zaakidentificatie"."id", "zaken_zaakidentificatie"."identificatie", "zaken_zaakidentificatie"."bronorganisatie", "zaken_zaak"."_etag", "zaken_zaak"."identificatie_ptr_id", "zaken_zaak"."uuid", "zaken_zaak"."id", "zaken_zaak"."identificatie", "zaken_zaak"."bronorganisatie", "zaken_zaak"."hoofdzaak_id", "zaken_zaak"."omschrijving", "zaken_zaak"."toelichting", "zaken_zaak"."_zaaktype_base_url_id", "zaken_zaak"."_zaaktype_relative_url", "zaken_zaak"."_zaaktype_id", "zaken_zaak"."registratiedatum", "zaken_zaak"."verantwoordelijke_organisatie", "zaken_zaak"."startdatum", "zaken_zaak"."einddatum", "zaken_zaak"."einddatum_gepland", "zaken_zaak"."uiterlijke_einddatum_afdoening", "zaken_zaak"."publicatiedatum", "zaken_zaak"."producten_of_diensten", "zaken_zaak"."communicatiekanaal", "zaken_zaak"."vertrouwelijkheidaanduiding", "zaken_zaak"."betalingsindicatie", "zaken_zaak"."laatste_betaaldatum", "zaken_zaak"."zaakgeometrie", "zaken_zaak"."verlenging_reden", to_char("zaken_zaak"."verlenging_duur", \'PYYYY"Y"MM"M"DD"DT"HH24"H"MI"M"SS.US"S"\'), "zaken_zaak"."opschorting_indicatie", "zaken_zaak"."opschorting_reden", "zaken_zaak"."opschorting_eerdere_opschorting", "zaken_zaak"."selectielijstklasse", "zaken_zaak"."archiefnominatie", "zaken_zaak"."archiefstatus", "zaken_zaak"."archiefactiedatum", "zaken_zaak"."opdrachtgevende_organisatie", "zaken_zaak"."processobjectaard", "zaken_zaak"."startdatum_bewaartermijn", "zaken_zaak"."processobject_datumkenmerk", "zaken_zaak"."processobject_identificatie", "zaken_zaak"."processobject_objecttype", "zaken_zaak"."processobject_registratie", "zaken_zaak"."communicatiekanaal_naam", "zaken_zaak"."created_on", "zaken_zaak"."_json" FROM "zaken_zaak" INNER JOIN "zaken_zaakidentificatie" ON ("zaken_zaak"."identificatie_ptr_id" = "zaken_zaakidentificatie"."id") ORDER BY "zaken_zaak"."identificatie_ptr_id" DESC LIMIT 100',
    'SELECT "catalogi_zaaktype"."id", "catalogi_zaaktype"."_etag", "catalogi_zaaktype"."datum_begin_geldigheid", "catalogi_zaaktype"."datum_einde_geldigheid", "catalogi_zaaktype"."concept", "catalogi_zaaktype"."uuid", "catalogi_zaaktype"."identificatie", "catalogi_zaaktype"."zaaktype_omschrijving", "catalogi_zaaktype"."zaaktype_omschrijving_generiek", "catalogi_zaaktype"."vertrouwelijkheidaanduiding", "catalogi_zaaktype"."doel", "catalogi_zaaktype"."aanleiding", "catalogi_zaaktype"."toelichting", "catalogi_zaaktype"."indicatie_intern_of_extern", "catalogi_zaaktype"."handeling_initiator", "catalogi_zaaktype"."onderwerp", "catalogi_zaaktype"."handeling_behandelaar", to_char("catalogi_zaaktype"."doorlooptijd_behandeling", \'PYYYY"Y"MM"M"DD"DT"HH24"H"MI"M"SS.US"S"\'), to_char("catalogi_zaaktype"."servicenorm_behandeling", \'PYYYY"Y"MM"M"DD"DT"HH24"H"MI"M"SS.US"S"\'), "catalogi_zaaktype"."opschorting_en_aanhouding_mogelijk", "catalogi_zaaktype"."verlenging_mogelijk", to_char("catalogi_zaaktype"."verlengingstermijn", \'PYYYY"Y"MM"M"DD"DT"HH24"H"MI"M"SS.US"S"\'), "catalogi_zaaktype"."trefwoorden", "catalogi_zaaktype"."publicatie_indicatie", "catalogi_zaaktype"."publicatietekst", "catalogi_zaaktype"."verantwoordingsrelatie", "catalogi_zaaktype"."versiedatum", "catalogi_zaaktype"."verantwoordelijke", "catalogi_zaaktype"."producten_of_diensten", "catalogi_zaaktype"."selectielijst_procestype", "catalogi_zaaktype"."selectielijst_procestype_jaar", "catalogi_zaaktype"."referentieproces_naam", "catalogi_zaaktype"."referentieproces_link", "catalogi_zaaktype"."broncatalogus_url", "catalogi_zaaktype"."broncatalogus_domein", "catalogi_zaaktype"."broncatalogus_rsin", "catalogi_zaaktype"."bronzaaktype_url", "catalogi_zaaktype"."bronzaaktype_identificatie", "catalogi_zaaktype"."bronzaaktype_omschrijving", "catalogi_zaaktype"."catalogus_id" FROM "catalogi_zaaktype" WHERE ("catalogi_zaaktype"."id") IN ((100), (99), (98))',
    'SELECT "zaken_zaakidentificatie"."id", "zaken_zaakidentificatie"."identificatie", "zaken_zaakidentificatie"."bronorganisatie", "zaken_zaak"."_etag", "zaken_zaak"."identificatie_ptr_id", "zaken_zaak"."uuid", "zaken_zaak"."id", "zaken_zaak"."identificatie", "zaken_zaak"."bronorganisatie", "zaken_zaak"."hoofdzaak_id", "zaken_zaak"."omschrijving", "zaken_zaak"."toelichting", "zaken_zaak"."_zaaktype_base_url_id", "zaken_zaak"."_zaaktype_relative_url", "zaken_zaak"."_zaaktype_id", "zaken_zaak"."registratiedatum", "zaken_zaak"."verantwoordelijke_organisatie", "zaken_zaak"."startdatum", "zaken_zaak"."einddatum", "zaken_zaak"."einddatum_gepland", "zaken_zaak"."uiterlijke_einddatum_afdoening", "zaken_zaak"."publicatiedatum", "zaken_zaak"."producten_of_diensten", "zaken_zaak"."communicatiekanaal", "zaken_zaak"."vertrouwelijkheidaanduiding", "zaken_zaak"."betalingsindicatie", "zaken_zaak"."laatste_betaaldatum", "zaken_zaak"."zaakgeometrie", "zaken_zaak"."verlenging_reden", to_char("zaken_zaak"."verlenging_duur", \'PYYYY"Y"MM"M"DD"DT"HH24"H"MI"M"SS.US"S"\'), "zaken_zaak"."opschorting_indicatie", "zaken_zaak"."opschorting_reden", "zaken_zaak"."opschorting_eerdere_opschorting", "zaken_zaak"."selectielijstklasse", "zaken_zaak"."archiefnominatie", "zaken_zaak"."archiefstatus", "zaken_zaak"."archiefactiedatum", "zaken_zaak"."opdrachtgevende_organisatie", "zaken_zaak"."processobjectaard", "zaken_zaak"."startdatum_bewaartermijn", "zaken_zaak"."processobject_datumkenmerk", "zaken_zaak"."processobject_identificatie", "zaken_zaak"."processobject_objecttype", "zaken_zaak"."processobject_registratie", "zaken_zaak"."communicatiekanaal_naam", "zaken_zaak"."created_on", "zaken_zaak"."_json" FROM "zaken_zaak" INNER JOIN "zaken_zaakidentificatie" ON ("zaken_zaak"."identificatie_ptr_id" = "zaken_zaakidentificatie"."id") WHERE "zaken_zaak"."hoofdzaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
    'SELECT "zaken_relevantezaakrelatie"."id", "zaken_relevantezaakrelatie"."zaak_id", "zaken_relevantezaakrelatie"."_relevant_zaak_base_url_id", "zaken_relevantezaakrelatie"."_relevant_zaak_relative_url", "zaken_relevantezaakrelatie"."_relevant_zaak_id", "zaken_relevantezaakrelatie"."aard_relatie", "zaken_relevantezaakrelatie"."overige_relatie", "zaken_relevantezaakrelatie"."toelichting", "zaken_zaakidentificatie"."id", "zaken_zaakidentificatie"."identificatie", "zaken_zaakidentificatie"."bronorganisatie", T3."_etag", T3."identificatie_ptr_id", T3."uuid", T3."id", T3."identificatie", T3."bronorganisatie", T3."hoofdzaak_id", T3."omschrijving", T3."toelichting", T3."_zaaktype_base_url_id", T3."_zaaktype_relative_url", T3."_zaaktype_id", T3."registratiedatum", T3."verantwoordelijke_organisatie", T3."startdatum", T3."einddatum", T3."einddatum_gepland", T3."uiterlijke_einddatum_afdoening", T3."publicatiedatum", T3."producten_of_diensten", T3."communicatiekanaal", T3."vertrouwelijkheidaanduiding", T3."betalingsindicatie", T3."laatste_betaaldatum", T3."zaakgeometrie", T3."verlenging_reden", to_char(T3."verlenging_duur", \'PYYYY"Y"MM"M"DD"DT"HH24"H"MI"M"SS.US"S"\'), T3."opschorting_indicatie", T3."opschorting_reden", T3."opschorting_eerdere_opschorting", T3."selectielijstklasse", T3."archiefnominatie", T3."archiefstatus", T3."archiefactiedatum", T3."opdrachtgevende_organisatie", T3."processobjectaard", T3."startdatum_bewaartermijn", T3."processobject_datumkenmerk", T3."processobject_identificatie", T3."processobject_objecttype", T3."processobject_registratie", T3."communicatiekanaal_naam", T3."created_on", T3."_json" FROM "zaken_relevantezaakrelatie" LEFT OUTER JOIN "zaken_zaak" T3 ON ("zaken_relevantezaakrelatie"."_relevant_zaak_id" = T3."identificatie_ptr_id") LEFT OUTER JOIN "zaken_zaakidentificatie" ON (T3."identificatie_ptr_id" = "zaken_zaakidentificatie"."id") WHERE "zaken_relevantezaakrelatie"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
    'SELECT "zaken_zaakkenmerk"."id", "zaken_zaakkenmerk"."zaak_id", "zaken_zaakkenmerk"."kenmerk", "zaken_zaakkenmerk"."bron" FROM "zaken_zaakkenmerk" WHERE "zaken_zaakkenmerk"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
    'SELECT "zaken_resultaat"."id", "zaken_resultaat"."_etag", "zaken_resultaat"."uuid", "zaken_resultaat"."zaak_id", "zaken_resultaat"."_resultaattype_base_url_id", "zaken_resultaat"."_resultaattype_relative_url", "zaken_resultaat"."_resultaattype_id", "zaken_resultaat"."toelichting" FROM "zaken_resultaat" WHERE "zaken_resultaat"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
    'SELECT "zaken_zaakeigenschap"."id", "zaken_zaakeigenschap"."_etag", "zaken_zaakeigenschap"."uuid", "zaken_zaakeigenschap"."zaak_id", "zaken_zaakeigenschap"."_eigenschap_base_url_id", "zaken_zaakeigenschap"."_eigenschap_relative_url", "zaken_zaakeigenschap"."_eigenschap_id", "zaken_zaakeigenschap"."_naam", "zaken_zaakeigenschap"."waarde" FROM "zaken_zaakeigenschap" WHERE "zaken_zaakeigenschap"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
    'SELECT "zaken_status"."id", "zaken_status"."_etag", "zaken_status"."uuid", "zaken_status"."zaak_id", "zaken_status"."_statustype_base_url_id", "zaken_status"."_statustype_relative_url", "zaken_status"."_statustype_id", "zaken_status"."datum_status_gezet", "zaken_status"."statustoelichting", "zaken_status"."gezetdoor_id" FROM "zaken_status" WHERE "zaken_status"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401) ORDER BY "zaken_status"."datum_status_gezet" DESC',
    'SELECT "zaken_rol"."id", "zaken_rol"."_etag", "zaken_rol"."uuid", "zaken_rol"."zaak_id", "zaken_rol"."betrokkene", "zaken_rol"."betrokkene_type", "zaken_rol"."afwijkende_naam_betrokkene", "zaken_rol"."_roltype_base_url_id", "zaken_rol"."_roltype_relative_url", "zaken_rol"."_roltype_id", "zaken_rol"."omschrijving", "zaken_rol"."omschrijving_generiek", "zaken_rol"."roltoelichting", "zaken_rol"."registratiedatum", "zaken_rol"."indicatie_machtiging", "zaken_rol"."contactpersoon_rol_emailadres", "zaken_rol"."contactpersoon_rol_functie", "zaken_rol"."contactpersoon_rol_telefoonnummer", "zaken_rol"."contactpersoon_rol_naam", "zaken_rol"."authenticatie_context", "zaken_rol"."begin_geldigheid", "zaken_rol"."einde_geldigheid" FROM "zaken_rol" WHERE "zaken_rol"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
    'SELECT "zaken_zaakinformatieobject"."id", "zaken_zaakinformatieobject"."_etag", "zaken_zaakinformatieobject"."uuid", "zaken_zaakinformatieobject"."zaak_id", "zaken_zaakinformatieobject"."_informatieobject_base_url_id", "zaken_zaakinformatieobject"."_informatieobject_relative_url", "zaken_zaakinformatieobject"."_informatieobject_id", "zaken_zaakinformatieobject"."aard_relatie", "zaken_zaakinformatieobject"."titel", "zaken_zaakinformatieobject"."beschrijving", "zaken_zaakinformatieobject"."registratiedatum", "zaken_zaakinformatieobject"."_objectinformatieobject_url", "zaken_zaakinformatieobject"."vernietigingsdatum", "zaken_zaakinformatieobject"."status_id" FROM "zaken_zaakinformatieobject" WHERE "zaken_zaakinformatieobject"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
    'SELECT "zaken_zaakobject"."id", "zaken_zaakobject"."uuid", "zaken_zaakobject"."zaak_id", "zaken_zaakobject"."object", "zaken_zaakobject"."relatieomschrijving", "zaken_zaakobject"."object_type", "zaken_zaakobject"."object_type_overige", "zaken_zaakobject"."object_type_overige_definitie", "zaken_zaakobject"."_zaakobjecttype_base_url_id", "zaken_zaakobject"."_zaakobjecttype_relative_url", "zaken_zaakobject"."_zaakobjecttype_id" FROM "zaken_zaakobject" WHERE "zaken_zaakobject"."zaak_id" IN (3500, 3499, 3498, 3497, 3496, 3495, 3494, 3493, 3492, 3491, 3490, 3489, 3488, 3487, 3486, 3485, 3484, 3483, 3482, 3481, 3480, 3479, 3478, 3477, 3476, 3475, 3474, 3473, 3472, 3471, 3470, 3469, 3468, 3467, 3466, 3465, 3464, 3463, 3462, 3461, 3460, 3459, 3458, 3457, 3456, 3455, 3454, 3453, 3452, 3451, 3450, 3449, 3448, 3447, 3446, 3445, 3444, 3443, 3442, 3441, 3440, 3439, 3438, 3437, 3436, 3435, 3434, 3433, 3432, 3431, 3430, 3429, 3428, 3427, 3426, 3425, 3424, 3423, 3422, 3421, 3420, 3419, 3418, 3417, 3416, 3415, 3414, 3413, 3412, 3411, 3410, 3409, 3408, 3407, 3406, 3405, 3404, 3403, 3402, 3401)',
]
...
class ZaakViewSet(
    ...
    def get_queryset(self):
        ...
        # zaak_pks = list(qs.values_list("pk", flat=True))
        # type_pks = list(qs.values_list("_zaaktype", flat=True))
        # prefetches = [
        #     str(ZaakType.objects.filter(pk__in=type_pks).query),
        #     str(Zaak.objects.filter(hoofdzaak__in=zaak_pks).query),
        #     # FIXME is this correct?
        #     str(RelevanteZaakRelatie.objects.filter(zaak__in=zaak_pks).query),
        #     str(ZaakKenmerk.objects.filter(zaak__in=zaak_pks).query),
        #     str(Resultaat.objects.filter(zaak__in=zaak_pks).query),
        #     str(ZaakEigenschap.objects.filter(zaak__in=zaak_pks).query),
        #     str(Status.objects.order_by("-datum_status_gezet").filter(zaak__in=zaak_pks).query),
        #     str(Rol.objects.filter(zaak__in=zaak_pks).query),
        #     str(ZaakInformatieObject.objects.filter(zaak__in=zaak_pks).query),
        #     str(ZaakObject.objects.filter(zaak__in=zaak_pks).query),
        # ]
