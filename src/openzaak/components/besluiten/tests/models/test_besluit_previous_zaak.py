...
class BesluitPreviousZaakTestCase(APITestCase):
    ...
    def test_zaak_external(self):
        ServiceFactory.create(
            api_root="https://external.zaken.nl/api/v1/zaken/",
            api_type=APITypes.zrc,
        )
        ServiceFactory.create(
            api_root="https://external.catalogi.nl/api/v1/zaaktype/",
            api_type=APITypes.ztc,
        )
        zaak_before = "https://external.zaken.nl/api/v1/zaken/19b702ce-1387-42a3-87d9-b070e8c3f43d"
        zaak_after = "https://external.zaken.nl/api/v1/zaken/7ef7d016-b766-4456-a90c-8908eeb19b49"
        zaaktype = "https://external.catalogi.nl/api/v1/zaaktype/11b1cfc2-7f7a-4561-aa62-715819ed468c"
