...
from ..factories import BesluitInformatieObjectFactory, BesluitFactory
...
class BesluitInformatieObjectAdminTests(AdminTestMixin, TestCase):
    ...
    def test_change_bio(self):
        ...
        bio_url = get_operation_url("besluitinformatieobject_read", uuid=bio.uuid)
        change_url = reverse('admin:besluiten_besluitinformatieobject_change', args=(bio.pk,))
        data = {
            "uuid": bio.uuid,
    ...
    def test_delete_bio_action(self):
        ...
        data = {'action': 'delete_selected', '_selected_action': [bio.id], 'post': 'yes'}
    ...
    def test_delete_bio(self):
        ...
        bio_url = get_operation_url("besluitinformatieobject_read", uuid=bio.uuid)
        besluit_url = get_operation_url("besluit_read", uuid=bio.besluit.uuid)
        delete_url = reverse('admin:besluiten_besluitinformatieobject_delete', args=(bio.pk,))
        data = {'post': 'yes'}
