...
@override_settings(NOTIFICATIONS_DISABLED=False, LOGGING=LOGGING_SETTINGS, CMIS_ENABLED=False)
...
@override_settings(NOTIFICATIONS_DISABLED=False, LOGGING=LOGGING_SETTINGS, CMIS_ENABLED=True)
@freeze_time("2019-01-01T12:00:00Z")
