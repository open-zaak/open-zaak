...
# Generated by Django 5.2.15 on 2026-07-31 13:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='applicatie',
            field=models.ForeignKey(blank=True, help_text='The application to which this authorisation belongs', null=True, on_delete=django.db.models.deletion.CASCADE, to='authorizations.applicatie'),
        ),
        migrations.AddField(
            model_name='catalogusautorisatie',
            name='new_applicatie',
            field=models.ForeignKey(blank=True, help_text='The application to which this authorisation belongs', null=True, on_delete=django.db.models.deletion.CASCADE, to='autorisaties.applicatie'),
        ),
        migrations.CreateModel(
            name='Autorisatie',
            fields=[
