...
API
~~~
* ``applicatie_consumer``: completed a custom consumer action on ``Applicatie`` via the API. Additional context: ``client_id``.
...
* ``applicatie_partial_updated``: partially updated an ``Applicatie`` via the API. Additional context: ``uuid``, ``client_id``.
* ``applicatie_updated``: updated an ``Applicatie`` via the API. Additional context: ``uuid``, ``client_id``.

* ``audittrail_list``: listed audit trail entries via the API. Additional context: ``view``, ``zaak_uuid``, ``client_id``, ``method``, ``count``.
* ``audittrail_retrieve``: retrieved an audit trail entry via the API. Additional context: ``view``, ``zaak_uuid``, ``audittrail_uuid``, ``client_id``, ``method``, ``status_code``.

* ``bestandsdeel_updated``: updated a ``Bestandsdeel`` via the API. Additional context: ``uuid``, ``data``, ``client_id``.
...
* ``besluit_partial_updated``: partially updated a ``Besluit`` via the API. Additional context: ``uuid``, ``client_id``.
* ``besluit_updated``: updated a ``Besluit`` via the API. Additional context: ``uuid``, ``client_id``.
...
* ``besluittype_created``: created a ``Besluittype`` via the API. Additional context: ``created_id``, ``client_id``.
...
* ``catalogus_created``: created a ``Catalogus`` via the API. Additional context: ``created_id``, ``client_id``.
...
* ``eio_created``: created an ``EnkelvoudigInformatieObject`` via the API. Additional context: ``uuid``, ``client_id``.
* ``eio_partial_updated``: partially updated an ``EnkelvoudigInformatieObject`` via the API. Additional context: ``uuid``, ``client_id``.
* ``eio_updated``: updated an ``EnkelvoudigInformatieObject`` via the API. Additional context: ``uuid``, ``client_id``.

* ``eigenschap_created``: created an ``Eigenschap`` via the API. Additional context: ``created_id``, ``client_id``.
...
* ``gebruiksrechten_partial_updated``: partially updated a ``Gebruiksrechten`` via the API. Additional context: ``uuid``, ``client_id``.
* ``gebruiksrechten_updated``: updated a ``Gebruiksrechten`` via the API. Additional context: ``uuid``, ``client_id``.
...
* ``verzending_partial_updated``: partially updated a ``Verzending`` via the API. Additional context: ``uuid``, ``data``, ``status_code``, ``client_id``.
...
* ``zaakinformatieobject_partially_updated``: partially updated a ZaakInformatieObject via the API. Additional context: ``uuid``, ``zaak_uuid``, ``client_id``.
* ``zaakinformatieobject_updated``: updated a ZaakInformatieObject via the API. Additional context: ``uuid``, ``zaak_uuid``, ``client_id``.

* ``zaaknummer_gereserveerd``: reserved one or more Zaak numbers via the API. Additional context: ``client_id``, ``path``, ``method``, ``input_data``, ``response_data``, ``count``.
...
* ``zaakobject_partially_updated``: partially updated a ZaakObject via the API. Additional context: ``uuid``, ``zaak_uuid``, ``client_id``.
* ``zaakobject_updated``: updated a ZaakObject via the API. Additional context: ``uuid``, ``zaak_uuid``, ``client_id``.
