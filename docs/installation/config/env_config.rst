...
* ``ZAAK_IDENTIFICATIE_GENERATOR``: Select one of the options defined in ZAAK_IDENTIFICATIE_GENERATOR_OPTIONS that define how the ZAAK identificatie is generated. Defaults to: ``use-start-datum-year``.
