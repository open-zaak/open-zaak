...
certifi==2018.4.16        # via -r requirements/base.txt, requests, sentry-sdk
cffi==1.13.2              # via -r requirements/base.txt, cryptography
chardet==3.0.4            # via -r requirements/base.txt, requests
click==7.1.2              # via -r requirements/test-tools.in, black
...
cryptography==3.2.1       # via -r requirements/base.txt, django-auth-adfs
