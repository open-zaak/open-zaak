...
* [:open-zaak:`2259`] Add ``data`` cloudevents with attributes to enable filtering via Open Notificaties (TODO check if docs are up to date)
...
* [:open-zaak:`2251`] Add handlers for ``zaak-gekoppeld`` and ``zaak-ontkoppeld`` events
  to create ZaakObjecten (TODO add docs for this?)
